...
<div class="form-body">
    <div class="tabbable-custom">
        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#tab_1" role="tab">Basic</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab_2" role="tab">Roles</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab_3" role="tab">Permissions</a>
            </li>
            @if(isset($id))
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab_4" role="tab"> New Password</a>
            </li>
            @endif
        </ul>
