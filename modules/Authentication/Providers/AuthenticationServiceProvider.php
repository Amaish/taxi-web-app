...
use Modules\Authentication\Entities\Authentication;
use Modules\Authentication\Repositories\EloquentAuthentication;
...
class AuthenticationServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        AliasLoader::getInstance()->alias(
            'Authentication',
            'Modules\Authentication\Facades\Facade'
        );
    }
    ...
    public function register()
    {
        ...
        $app->bind('Modules\Authentication\Repositories\AuthenticationInterface', function (Application $app) {
            $repository = new EloquentAuthentication(new Authentication);
            return $repository;
        });
    }
