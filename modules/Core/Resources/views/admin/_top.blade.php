<div class="topbar">
    ...
    <div class="topbar-left">
        ...
        <span>
            <img src="{!! asset('asset/images/logo.png') !!}" alt="" height="65">
        </span>
            <i>
                <img src="{!! asset('asset/images/logo-sm.png') !!}" alt="" height="30">
            </i>
        </a>
    </div>
            ...
            <li class="dropdown notification-list">
                <div class="dropdown notification-list nav-pro-img">
                    <a class="dropdown-toggle nav-link arrow-none waves-effect nav-user" data-toggle="dropdown"
                       href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        <img src="{!! asset('asset/images/avatar.png') !!}" alt="user" class="rounded-circle">
                        {{current_user_email()}}
                    </a>
                    <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                        ...
                        <a class="dropdown-item" href="#"><i class="mdi mdi-account-circle m-r-5"></i>
                            Profile</a>
                        <a class="dropdown-item d-block" href="{{route('admin.users.change-password')}}">
